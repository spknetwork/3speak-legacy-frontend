...
(function(factory) {
    ...
    var TitleOverlayPlugin = function(player, options) {
        ...
        var createOverlayContainer_ = function() {
            ...
            this.titleOverlayContainer.style.position = "absolute";
            this.titleOverlayContainer.style.top = "0";
            this.titleOverlayContainer.style.left = "0";
            ...
            this.titleOverlayTextContainer.style.zIndex = '10000';
